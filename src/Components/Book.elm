...
import Components.Molecules.Footer exposing (footerChapter)
import Components.Organisms.Search exposing (searchChapter)
import Components.Molecules.Header exposing (headerChapter)
